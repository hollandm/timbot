    ...
    def main(self):
        while True:
            ...
            for i in range(0, self.my_joystick.get_numaxes()):
                if self.my_joystick.get_axis(i) > 0.15 or self.my_joystick.get_axis(i) < -0.15:
...
#
#joystick.init()
##joy = 0     # just to get rid of compiler warnings
#
#try:
#    joy = joystick.Joystick(0)
#    joy.init()
#    print "Using " + str(joy.get_name())
#
#    #numAxes = joy.get_numaxes()
#    while joy.get_axis(0)*100 < 99:
#        print(round(joy.get_axis(0)*100))
...
#
#except pygame.error:
#    print "No joystick could be found"
#    joystick.quit()
#    exit()
#
## now close open resources
#joy.quit()
#joystick.quit()
#
#
